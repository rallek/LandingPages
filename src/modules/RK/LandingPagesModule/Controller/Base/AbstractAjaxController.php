...
abstract class AbstractAjaxController extends AbstractController
{
    ...
    {
        if (!$this->hasPermission('RKLandingPagesModule::Ajax', '::', ACCESS_EDIT)) {
            return true;
        }
        ...
        $entityDisplayHelper = $this->get('rk_landingpages_module.entity_display_helper');
    ...
    protected function prepareSlimItem($repository, $objectType, $item, $itemId, $descriptionField)
    {
        ...
        $previewParameters = $this->get('rk_landingpages_module.controller_helper')->addTemplateParameters($objectType, $previewParameters, 'controllerAction', $contextArgs);
    
        $previewInfo = base64_encode($this->get('twig')->render('@RKLandingPagesModule/External/' . ucfirst($objectType) . '/info.html.twig', $previewParameters));
    
        $title = $this->get('rk_landingpages_module.entity_display_helper')->getFormattedTitle($item);
