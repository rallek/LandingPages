...
use RK\LandingPagesModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'RK\\LandingPagesModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return RK\LandingPagesModule\Entity\pageEntity The newly created entity instance
     */
    public function createPage()
    {
        $entityClass = 'RK\\LandingPagesModule\\Entity\\PageEntity';
     ...
     *
     * @return RK\LandingPagesModule\Entity\imageEntity The newly created entity instance
     */
    public function createImage()
    {
        $entityClass = 'RK\\LandingPagesModule\\Entity\\ImageEntity';
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'RKLandingPagesModule:' . ucfirst($objectType) . 'Entity';
