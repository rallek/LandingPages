...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from landing pages app';
     *     $event->getRequest()->attributes->set('RKLandingPagesModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('RKLandingPagesModule_test');`
     *     now `$testMessage` should be: `'Hello from landing pages app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('landing pages App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
