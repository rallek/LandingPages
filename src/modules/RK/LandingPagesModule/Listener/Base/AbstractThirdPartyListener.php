...
abstract class AbstractThirdPartyListener implements EventSubscriberInterface
{
    ...
    public function contentGetTypes(\Zikula_Event $event)
    {
        ...
        $types->add('RKLandingPagesModule_ContentType_Item');
        
        // plugin for showing a list of multiple items
        $types->add('RKLandingPagesModule_ContentType_ItemList');
    }
    ...
    public function getEditorHelpers(\Zikula_Event $event)
    {
        ...
        $helpers->add(
            [
                ...
                'type'   => 'javascript',
                'path'   => 'modules/RK/LandingPagesModule/Resources/public/js/RKLandingPagesModule.Finder.js'
            ]
        );
    }
    ...
    public function getTinyMcePlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                ...
                'path' => 'modules/RK/LandingPagesModule/Resources/scribite/TinyMce/rklandingpagesmodule/plugin.js'
            ]
        );
    }
    ...
    public function getCKEditorPlugins(\Zikula_Event $event)
    {
        ...
        $plugins->add(
            [
                'name' => 'rklandingpagesmodule',
                'path' => 'modules/RK/LandingPagesModule/Resources/scribite/CKEditor/rklandingpagesmodule/',
                'file' => 'plugin.js',
