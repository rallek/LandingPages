...
abstract class AbstractImageHelper
{
    ...
    public function __construct(
        ...
        $this->name = 'RKLandingPagesModule';
    }
    ...
    public function getCustomRuntimeOptions($objectType = '', $fieldName = '', $contextName = '', $context = '', $args = [])
    {
        $options = [
            'thumbnail' => [
                ...
                'mode'      => $this->variableApi->get('RKLandingPagesModule', 'thumbnailMode' . ucfirst($objectType) . ucfirst($fieldName), 'inset'),
        ...
        if ($contextName == $this->name . '_relateditem') {
            ...
            if (in_array($args['action'], ['view', 'display', 'edit'])) {
                ...
                $options['thumbnail']['size'] = [
                    $this->variableApi->get('RKLandingPagesModule', 'thumbnailWidth' . $fieldSuffix, $defaultWidth),
                    $this->variableApi->get('RKLandingPagesModule', 'thumbnailHeight' . $fieldSuffix, $defaultHeight)
                ];
            }
        }
