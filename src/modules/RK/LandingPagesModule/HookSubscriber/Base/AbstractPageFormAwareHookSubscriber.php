...
abstract class AbstractPageFormAwareHookSubscriber implements HookSubscriberInterface
{
    ...
    public function getEvents()
    {
        return [
            ...
            FormAwareCategory::TYPE_EDIT => 'rklandingpagesmodule.form_aware_hook.pages.edit',
            // Process the results of the edit form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_EDIT => 'rklandingpagesmodule.form_aware_hook.pages.process_edit',
            // Display hook for delete forms.
            FormAwareCategory::TYPE_DELETE => 'rklandingpagesmodule.form_aware_hook.pages.delete',
            // Process the results of the delete form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_DELETE => 'rklandingpagesmodule.form_aware_hook.pages.process_delete'
        ];
    }
}
