...
use RK\LandingPagesModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKLandingPagesModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $controllerReference = new ControllerReference('RKLandingPagesModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@RKLandingPagesModule/Block/item_modify.html.twig';
    }
