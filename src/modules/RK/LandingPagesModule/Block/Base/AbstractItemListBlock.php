...
namespace RK\LandingPagesModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use RK\LandingPagesModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('RKLandingPagesModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        // create query
        $orderBy = $this->get('rk_landingpages_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKLandingPagesModule items');
        }
        ...
        $templateParameters = $this->get('rk_landingpages_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    {
        return '@RKLandingPagesModule/Block/itemlist_modify.html.twig';
    }
