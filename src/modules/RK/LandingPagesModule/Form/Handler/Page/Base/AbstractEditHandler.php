...
namespace RK\LandingPagesModule\Form\Handler\Page\Base;

use RK\LandingPagesModule\Form\Handler\Common\EditHandler;
use RK\LandingPagesModule\Form\Type\PageType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create(PageType::class, $this->entityRef, $options);
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'RKLandingPagesModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'page', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
