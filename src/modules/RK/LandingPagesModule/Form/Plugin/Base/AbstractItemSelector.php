...
namespace RK\LandingPagesModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKLandingPagesModule:js/RKLandingPagesModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKLandingPagesModule:js/RKLandingPagesModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('RKLandingPagesModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }
        ...
        $view = Zikula_View::getInstance('RKLandingPagesModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKLandingPagesModule_objecttype', 'page');
