...
namespace RK\LandingPagesModule\ContentType\Base;
...
abstract class AbstractItemList extends \Content_AbstractContentType implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('RKLandingPagesModule list view');
    }
    ...
    {
        return $this->container->get('translator.default')->__('Display list of RKLandingPagesModule objects.');
    }
    ...
    {
        $controllerHelper = $this->container->get('rk_landingpages_module.controller_helper');
    ...
    {
        $repository = $this->container->get('rk_landingpages_module.entity_factory')->getRepository($this->objectType);
        $permissionApi = $this->container->get('zikula_permissions_module.api.permission');
    
        // create query
        $orderBy = $this->container->get('rk_landingpages_module.model_helper')->resolveSortParameter($this->objectType, $this->sorting);
        ...
        $templateParameters = $this->container->get('rk_landingpages_module.controller_helper')->addTemplateParameters($this->objectType, $templateParameters, 'contentType', []);
    ...
    protected function getDisplayTemplate()
    {
        ...
        foreach ($templateOptions as $templatePath) {
            if ($templating->exists('@RKLandingPagesModule/' . $templatePath)) {
                $template = '@RKLandingPagesModule/' . $templatePath;
                break;
            }
        }
    ...
    public function startEditing()
    {
        ...
        $this->view->toplevelmodule = 'RKLandingPagesModule';
    
        // ensure our custom plugins are loaded
        array_push($this->view->plugins_dir, 'modules/RK/LandingPagesModule/Resources/views/plugins');
    }
