...
namespace RK\LandingPagesModule\Twig\Base;
...
use RK\LandingPagesModule\Helper\EntityDisplayHelper;
use RK\LandingPagesModule\Helper\WorkflowHelper;
...
abstract class AbstractTwigExtension extends Twig_Extension
{
    ...
    {
        return [
            new \Twig_SimpleFunction('rklandingpagesmodule_objectTypeSelector', [$this, 'getObjectTypeSelector']),
            new \Twig_SimpleFunction('rklandingpagesmodule_templateSelector', [$this, 'getTemplateSelector'])
        ];
    }
    ...
    {
        return [
            new \Twig_SimpleFilter('rklandingpagesmodule_fileSize', [$this, 'getFileSize'], ['is_safe' => ['html']]),
            new \Twig_SimpleFilter('rklandingpagesmodule_listEntry', [$this, 'getListEntry']),
            new \Twig_SimpleFilter('rklandingpagesmodule_formattedTitle', [$this, 'getFormattedEntityTitle']),
            new \Twig_SimpleFilter('rklandingpagesmodule_objectState', [$this, 'getObjectState'], ['is_safe' => ['html']])
        ];
    }
    
    /**
     * The rklandingpagesmodule_objectState filter displays the name of a given object's workflow state.
     * Examples:
     *    {{ item.workflowState|rklandingpagesmodule_objectState }}        {# with visual feedback #}
     *    {{ item.workflowState|rklandingpagesmodule_objectState(false) }} {# no ui feedback #}
     *
    ...
    /**
     * The rklandingpagesmodule_fileSize filter displays the size of a given file in a readable way.
     * Example:
     *     {{ 12345|rklandingpagesmodule_fileSize }}
     *
    ...
    /**
     * The rklandingpagesmodule_listEntry filter displays the name
     * or names for a given list item.
     * Example:
     *     {{ entity.listField|rklandingpagesmodule_listEntry('entityName', 'fieldName') }}
     *
    ...
    /**
     * The rklandingpagesmodule_objectTypeSelector function provides items for a dropdown selector.
     *
    ...
    /**
     * The rklandingpagesmodule_templateSelector function provides items for a dropdown selector.
     *
     * @return string The output of the plugin
     */
    ...
    /**
     * The rklandingpagesmodule_formattedTitle filter outputs a formatted title for a given entity.
     * Example:
     *     {{ myPost|rklandingpagesmodule_formattedTitle }}
     *
