...
/**
 * The rklandingpagesmoduleTemplateSelector plugin provides items for a dropdown selector.
 *
 ...
 */
function smarty_function_rklandingpagesmoduleTemplateSelector($params, $view)
{
